...
type UserResolver interface {
	...
	JobTitle(ctx context.Context, obj *model.User) (*string, error)
...
func (ec *executionContext) field_Query_GetUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["filter"]; ok {
		...
		arg0, err = ec.unmarshalNFilterInput2githubᚗcomᚋriyadennisᚋsigistᚋgraphqlᚑserviceᚋgraphᚋmodelᚐFilterInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _User_jobTitle(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.User().JobTitle(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputFilterInput(ctx context.Context, obj interface{}) (model.FilterInput, error) {
	...
	fieldsInOrder := [...]string{"id", "firstName", "lastName", "email", "jobTitle", "createAt"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
	...
	for i, field := range fields {
		...
		case "jobTitle":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._User_jobTitle(ctx, field, obj)
				return res
			}
